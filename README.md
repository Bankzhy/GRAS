...
- HanYu Zhang, Tomoji Kishi, *KG-Code: A Knowledge Graph Guided Pre-Training Approach for Code Representation*, 2025, pp. 872-876.[Link](https://ieeexplore.ieee.org/document/11396484)
- HanYu Zhang, Tomoji Kishi, *A Code Smell Refactoring Approach using GNNs* [Under Review].[Link](https://doi.org/10.48550/arXiv.2511.12069)
